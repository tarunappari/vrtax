...
export const BusinessCTA = ({
  title = "Simplify Your Business Tax Compliance Today",
  description = "From corporate filings to ongoing compliance support, we provide accurate and dependable tax solutions designed to keep your business in good standing.",
        ...
        <div className="grid items-center gap-8 lg:grid-cols-2">
          <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
            ...
            <motion.div variants={itemVariants} className={styles.buttonDiv}>
              <button>Speak with a Tax Specialist</button>
              <span>
